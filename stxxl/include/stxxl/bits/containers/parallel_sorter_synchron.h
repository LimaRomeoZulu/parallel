/***************************************************************************
 *  include/stxxl/bits/containers/parallel_sorter_synchron.h
 *
...
#ifndef STXXL_CONTAINERS_PARALLEL_SORTER_SYNCHRON_HEADER
#define STXXL_CONTAINERS_PARALLEL_SORTER_SYNCHRON_HEADER

#include <stxxl/bits/deprecated.h>
#include <stxxl/bits/stream/sort_stream_parallel_synchron.h>

STXXL_BEGIN_NAMESPACE

#ifndef STXXL_VERBOSE_PARALLEL_SORTER_SYNCHRON
#define STXXL_VERBOSE_PARALLEL_SORTER_SYNCHRON STXXL_VERBOSE2
#endif
...
class parallel_sorter_synchron : private noncopyable
{
public:
    // *** Template Parameters
...
public:
    ...
    parallel_sorter_synchron& operator ++ ()
    {
        assert(m_state == STATE_OUTPUT);
        ++m_runs_merger;
        return *this;
...
#endif // !STXXL_CONTAINERS_PARALLEL_SORTER_SYNCHRON_HEADER
// vim: et:ts=4:sw=4
